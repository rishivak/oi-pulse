...
def test_strategy_cannot_see_future_observation():
    obs = observation(instrument=NIFTY_25000_CE, observed_at="11:40:00",
                      ingested_at="11:44:00")
...
def test_replay_reproduces_live_event_stream():
    ...
    replayed = replay(period, knowledge_horizon=LOCKSTEP,
                      build_context_id=CTX, feature_versions=FV).events
